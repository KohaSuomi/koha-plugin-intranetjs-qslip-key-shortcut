package Koha::Plugin::Fi::KohaSuomi::QslipKeyShortcut;
...
our $metadata = {
    ...
    maximum_version => '',
    version         => $VERSION,
    description     => "Alt+P tulostaa pikakuitin (tämän päivän lainat/QSLIP) lainaussivulla",
};
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/QslipKeyShortcut/";
